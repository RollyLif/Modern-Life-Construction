    ...
    <section id="about" className="py-32 bg-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          {/* Image Content - 4 Poles Staggered Grid */}
          <motion.div
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="w-full lg:w-1/2 relative h-[500px] sm:h-[600px] grid grid-cols-2 gap-4"
          >
            {/* Colonne de gauche (décalée vers le haut) */}
            <div className="flex flex-col gap-4 transform -translate-y-8">
              {/* Génie Civil */}
